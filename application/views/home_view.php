					...
					<div class="container" style="width:60%;">
						<div id="carousel-berita" class="carousel slide" data-ride="carousel">
								...
								<ol class="carousel-indicators">
									<?php
									$berita = $popular_post->result_array();
								...
								<div class="carousel-inner" role="listbox">
									...
									foreach ($berita as $key => $value) {
										...
										echo '<div class="item ' . $active . '">
																<img src="' . base_url().'assets/images/thumb/'.$value['post_image'] . '" alt="…">
																	<div class="carousel-caption">
																		<h3><a href="'.site_url('blog/'.$value['post_slug']).'" target="_blank">'.$value['post_title'].'</a></h3>
																	</div>
															</div>';
									}
									?>
