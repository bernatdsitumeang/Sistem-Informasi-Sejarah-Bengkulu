...
<html>
    <head>
        ...
        <meta name="author" content="Idris Gatra Putra" />
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="<?php echo site_url('backend/dashboard');?>" class="logo-text"><span>Dashboard</span></a>
                    </div><!-- Logo Box -->
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <?php else:?>
                        <?php endif;?>
                        <li><a href="<?php echo site_url('');?>" target="_blank" class="waves-effect waves-button"><span class="menu-icon icon-link"></span><p>Lihat Blog</p></a></li>
            ...
            <div class="page-inner">
                ...
                <div class="page-footer">
                    <p class="no-s"><?php echo date('Y');?> &copy; Sejarah Bengkulu.</p>
                </div>
            </div><!-- Page Inner -->
        </main><!-- Page Content -->
